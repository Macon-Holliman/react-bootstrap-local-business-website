...
class ExploreNav extends Component {
  ...
  render() {
    ...
    return (
      <div class="row">
      <div class="explore-title-wrapper col-12">
        
      <div class="row">
        <div class="explore-title col-12 col-md-3">
          EXPLORE
        </div>

        <div class="buttons-wrapper col-12 col-md-9">
        <div class="row">
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore" onClick={() => {this.ChangePictures("Jewelry")}}>
            <div class="text-button"  id="jewelry-button"><div class='btn-text-cntr'>JEWELRY</div></div>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore" onClick={() => {this.ChangePictures("Beauty")}}>
            <div class="text-button" id="beauty-button"><div class='btn-text-cntr'>BEAUTY</div></div>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"  width="75px" height="27px"  viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore" onClick={() => {this.ChangePictures("Clothes")}}>
            <div class="text-button" id="clothes-button"><div class='btn-text-cntr'>CLOTHES</div></div>
            <svg  xmlns="http://www.w3.org/2000/svg" version="1.1"  width="75px" height="27px"  viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore" onClick={() => {this.ChangePictures("Home")}}>
            <div class="text-button" id="home-button"><div class='btn-text-cntr'>HOME</div></div>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"  width="75px" height="27px"  viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore"  onClick={() => {this.ChangePictures("Bags")}}>
            <div class="text-button" id="bags-button"><div class='btn-text-cntr'>BAGS</div></div>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="75px" height="27px" viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore" onClick={() => {this.ChangePictures("Kids")}}>
            <div class="text-button" id="kids-button"><div class='btn-text-cntr'>KIDS</div></div>
            <svg  xmlns="http://www.w3.org/2000/svg" version="1.1"  width="75px" height="27px"  viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore"  onClick={() => {this.ChangePictures("Food")}}>
            <div class="text-button" id="food-button"><div class='btn-text-cntr'>FOOD</div></div>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"  width="75px" height="27px"  viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
        ...
        <div class="col-4 col-sm-4 col-md-3 col-lg-2">
          <button class="button-explore" onClick={() => {this.ChangePictures("Tumblers")}}>
            <div class="text-button" id="tumblers-button"><div class='btn-text-cntr'>TUMBLERS</div></div>
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"  width="75px" height="27px"  viewBox="0 0 180 60" class="border-button" >
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="background"></polyline>
              <polyline points="179,1 179,59 1,59 1,1 179,1" class="button-line"></polyline>
            </svg>
  ...
  ChangePictures = (target)  => {
    ...
    for(var y = 0; y < imageContainers.length; y++)
    {
